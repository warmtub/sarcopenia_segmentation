...
def inference_list(file_list):
    global endpoint, access_key, secret_key, bucket, n_classes, net, value_to_label_name
    ...
    for file in file_list:
        ...
        with open(dicom_file.split(".")[0]+".json", "w") as outfile:
            json.dump(empty_response, outfile)
        print(f"{dicom_file}.json saved")



if __name__ == "__main__":
    file_list = ["Sarcopenia_data/SARCOPANIA0030.dcm", "Sarcopenia_data/SARCOPANIA0010.dcm", "Sarcopenia_data/SARCOPANIA0050.dcm"]
    inference_list(file_list)
